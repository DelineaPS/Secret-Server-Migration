...
$sourceRootUrl       = 'YOUR-SOURCE-SS-URL-WITHOUT-HTTPS VALUE'       # Source tenant root URL. Dont not include https
$destinationRootUrl  = 'YOUR-DESTINATION-SS-URL-WITHOUT-HTTPS VALUE'       # Destination tenant root URL Dont not include https
